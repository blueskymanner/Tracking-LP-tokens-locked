...
module.exports = async function DeepLocker() {
    ...
    cron.schedule('* * * * *', async () => {
        ...
        if (prev_TotalNums == total_tokenNums) {
            console.log("very equal to deepLocker."); 
            return;
        }
        else {
             console.log("very different to deepLocker.");
            ...
            let tokenLocksArr = await deepLockerPortal.methods.lockedToken(prev_TotalNums).call();
